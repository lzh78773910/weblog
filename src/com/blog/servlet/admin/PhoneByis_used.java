...
public class PhoneByis_used extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(falg){
			if(is_used==0){
				...
				response.getWriter().println("<script>alert('ÕÕÆ¬É¾³ý³É¹¦');location.href='AlbumDetailsServlet?currentPage="+cPage+"&al_id="+al_id+"'</script>");
			}else{
				System.out.println("ÕÕÆ¬»Ö¸´³É¹¦");
				response.getWriter().println("<script>alert('ÕÕÆ¬»Ö¸´³É¹¦');location.href='AlbumDetailsServlet?currentPage="+cPage+"&al_id="+al_id+"'</script>");
			}
		}else{
