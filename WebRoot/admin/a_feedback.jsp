...
<div class="neirong"> 
  ...
  <tbody>
    <tr>
      ...
      <td width="150"><a href="adminservlet/FeedbackDetailsServlet?f_id=${feedback.f_id }">查看</a>
   </td>
    </tr>
</c:forEach>
  </tbody>
   ...
   &nbsp;<a href="adminservlet/FeedbackServlet?currentPage=1">首页
   </a>&nbsp;<a href="adminservlet/FeedbackServlet?currentPage=${page.currentPage==1?1 : page.currentPage-1}"> 上一页</a>
	  &nbsp;<b>${page.currentPage}/${page.totalPage}</b>&nbsp;</b>
	  <a href="adminservlet/FeedbackServlet?currentPage=${page.currentPage == page.totalPage?page.totalPage : page.currentPage+1}">下一页
	  </a>&nbsp;<a href="adminservlet/FeedbackServlet?currentPage=${page.totalPage}">尾页</a>
	  </div>
</div>	
	</div>
</body>
