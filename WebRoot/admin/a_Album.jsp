...
<div class="neirong" > 
  ...
  <tbody>
    ...
    <tr>
      <td>${albums.al_id }</td>
      <td>${albums.al_name }(${albums.count })</td>
	  ...
	  <a href="adminservlet/AlbumsByis_used?is_used=0&al_id=${albums.al_id }&currentPage=${page.currentPage}">删除</a></td>
    </tr>
    	  </c:forEach>
   ...
   &nbsp;<a href="adminservlet/AlbumServlet?currentPage=1">首页
   </a>&nbsp;<a href="adminservlet/AlbumServlet?currentPage=${page.currentPage==1?1 : page.currentPage-1}"> 上一页</a>
	  &nbsp;<b>${page.currentPage}/${page.totalPage}</b>&nbsp;</b>
	  <a href="adminservlet/AlbumServlet?currentPage=${page.currentPage == page.totalPage?page.totalPage : page.currentPage+1}">下一页
	  </a>&nbsp;<a href="adminservlet/AlbumServlet?currentPage=${page.totalPage}">尾页</a>
	  </div>
</div>	
	</div>
</body>
