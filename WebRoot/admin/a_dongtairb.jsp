...
<div class="neirong"> 
  ...
  <tbody>
    <tr>
      ...
      <td width="150"><a href="adminservlet/DongTaiDetails?d_id=${dongtai.d_id }">查看
       <a href="adminservlet/DongTaiObtainServlet?d_id=${dongtai.d_id }">修改</a>
      <a href="adminservlet/DongTaiDeleteServlet?d_id=${dongtai.d_id }&is_used=1&currentPage=${page.currentPage}">恢复</a></td>
    </tr>
	</c:forEach>
  </tbody>
</table>
   ...
   &nbsp;<a href="adminservlet/DongTaiRBServlet?currentPage=1">首页
   </a>&nbsp;<a href="adminservlet/DongTaiRBServlet?currentPage=${page.currentPage==1?1 : page.currentPage-1}"> 上一页</a>
	  &nbsp;<b>${page.currentPage}/${page.totalPage}</b>&nbsp;</b>
	  <a href="adminservlet/DongTaiRBServlet?currentPage=${page.currentPage == page.totalPage?page.totalPage : page.currentPage+1}">下一页
	  </a>&nbsp;<a href="adminservlet/DongTaiRBServlet?currentPage=${page.totalPage}">尾页</a>
	  </div>
</div>	
	</div>
</body>
