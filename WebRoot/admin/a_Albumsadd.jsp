...
<div class="neirong" > 
  ...
  <form action="adminservlet/AlbumsAddServlet" method="post" enctype="multipart/form-data">
    <tr>
      <td width="280" height="120" >相册名称</td>
      <td width="669" style="padding-left: 50px"><input name="al_name" type="text" id="wbk" style="width: 350px"></td>
    </tr>
    <tr>
      <td width="280" height="120">上传照片</td>
      <td width="669" style="padding-right: 50px"><input name="spicture" type="file" /> 格式只能为jpg，png
   <br/>
