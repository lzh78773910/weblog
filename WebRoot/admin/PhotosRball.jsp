...
<div class="xiangcegl">
  ...
  <tbody>
    ...
    <c:forEach items="${requestScope.page.photos }" var="photos">
      <td width="320" height="350" style="float: left;margin-left:5px;" ><a href="#" class="photo"><img src="<%=basePath%>css_js/admin/Albums/photos/${photos.p_url }" width="100%" height="310" ></a>
		  <br><span class="xiangceglin">相册-${photos.albums.al_name }&nbsp:&nbsp${photos.p_title }--
		  		  <a href="adminservlet/PhoneAllforByis_used?is_used=1&p_id=${photos.p_id }&currentPage=${page.currentPage}">恢复</a>
		  </span></td>
		  </c:forEach>
    </tr>
		</tbody>
   ...
   &nbsp;<a href="adminservlet/PhotosRBAllServlet?currentPage=1">首页
   </a>&nbsp;<a href="adminservlet/PhotosRBAllServlet?currentPage=${page.currentPage==1?1 : page.currentPage-1}"> 上一页</a>
	  &nbsp;<b>${page.currentPage}/${page.totalPage}</b>&nbsp;</b>
	  <a href="adminservlet/PhotosRBAllServlet?currentPage=${page.currentPage == page.totalPage?page.totalPage : page.currentPage+1}">下一页
	  </a>&nbsp;<a href="adminservlet/PhotosRBAllServlet?currentPage=${page.totalPage}">尾页</a>
	  </div>
	</div>
</body>
</html>
